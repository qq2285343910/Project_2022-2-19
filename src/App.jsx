...
const tld = '.lover';
const CONTRACT_ADDRESS = '0x84cc401cdf800596Feb97Ba79c78559D5Bb69C1F';
  ...
  try {
	...
	const renderNotConnectedContainer = () => (
		<div className="connect-wallet-container">
			<img src="https://media.giphy.com/media/06QKOpB8R93HtOeHZi/giphy.gif" alt="Ninja donut gif" />
...
const editRecord = (name) => {
	...
	<header>
    <div className="left">
      <p className="title">(❤ ω ❤) Pokemon Name Service</p>
